      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="space-y-6 order-2 lg:order-1">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-1 sm:mb-2">Full Arch Treatments Available</h3>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-1 sm:mb-2">Flexible Monthly Payment Plans</h3>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-1 sm:mb-2">Friendly Consultation including Free CBCT Scans & X-Rays</h3>
                  <p className="text-sm sm:text-base text-gray-600 font-semibold">($495 Value)</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg order-1 lg:order-2">
            <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-3 sm:mb-4 text-center">Watch our Short Video to learn more</h3>
